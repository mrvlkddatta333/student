...
urlpatterns = [
    ...
    path('activate_email/<uidb64>/<token>/', hod_views.activate_email, name='activate_email'),
    path('verify_email/<uidb64>/<token>/', hod_views.verify_email, name='verify_email'),
    path('student-activate-email/<uidb64>/<token>/', hod_views.student_activate_email, name='student_activate_email'),
    path('student-verify-email/', hod_views.student_verify_email, name='student_verify_email'),
